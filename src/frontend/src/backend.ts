...
export class Backend implements backendInterface {
    ...
    async deleteChunk(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteChunk(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async finalizeUpload(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getPaginatedPosts(arg0: bigint, arg1: bigint): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPaginatedPosts(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUploadState(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getUploadState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setUploadState(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUploadState(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadMediaChunk(arg0: bigint, arg1: bigint, arg2: bigint, arg3: Uint8Array): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadMediaChunk(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadMediaData(arg0: Uint8Array): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadMediaData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
